...
mkdir ~/.vnc
mkdir -p ~/.config/tigervnc/xstartup
...
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/DesktopEnvironment/Heavy/KDE/Apt/xstartup --no-check-certificate -P ~/.config/tigervnc/
