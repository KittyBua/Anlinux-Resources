...
if [ "$1" = "i386" ] || [ "$1" = "amd64" ] ; then
  ...
  echo "deb https://ppa.launchpadcontent.net/backbox/nine/ubuntu noble main" >> $2/etc/apt/sources.list
  echo "deb-src https://ppa.launchpadcontent.net/backbox/nine/ubuntu noble main" >> $2/etc/apt/sources.list
else  
